...
<script lang="js">
import Transition from 'src/layouts/General/Mixins/Transition'
import DashboardActions from 'src/layouts/Dashboard/components/DashboardActions'
import DashboardMenu from 'src/layouts/Dashboard/components/DashboardMenu'
