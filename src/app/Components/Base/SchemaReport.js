...
import Form from 'src/app/Components/Base/Contracts/Form'
// mixins
import SchemaBody from 'src/app/Components/Base/Form/Mixins/SchemaFormBody'
// app
  ...
  methods: {
    ...
    renderReportBody (h) {
      ...
      const data = {
        ...
        class: 'app-form-body',
        domProps: {
          action: `${this.baseURL}/report/process/${this.report}?c=${token}&p=${this.printing}`,
          method: 'post',
          target: 'report'
        }
      }
    ...
    renderReportIframe (h) {
      const data = {
        ...
        domProps: {
          src: `${this.baseURL}/report/loading`,
          id: 'report',
          name: 'report'
        }
      }
    ...
    reportBack () {
      ...
      this.$refs.iframe.src = `${this.baseURL}/report/loading`
    },
    /**
     */
    reportPrint () {
